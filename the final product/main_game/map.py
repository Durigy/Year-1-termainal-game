...
room_contaminated_area = {
    ...
    "description":
    """You're now standing in a dingy room, the only
light coming from a gas-powered lamp. In the corner,
held by chains, is a dead body. You step forward to
investigate, and it springs to life - an undead.
They clearly want to kill you, but cannot with the
chains holding them back, keeping them in place
against the wall.
...
fact, Dr. Gavigan's wife. You're shocked, but then again
... how else would he have been able to produce the vaccine.""",
